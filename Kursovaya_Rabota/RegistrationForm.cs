...
namespace Kursovaya_Rabota
{
    public partial class RegistrationForm : MetroForm
    {
        ...
        private void materialRaisedButton1_Click(object sender, EventArgs e)
        {
            ...
            string reglog = LoginRegBox.Text;
            string passlog = PasswordRegBox.Text;
            ...
            CMD.Parameters.Add("@reglog", MySqlDbType.VarChar).Value = LoginRegBox.Text;
            CMD.Parameters.Add("@passlog", MySqlDbType.VarChar).Value = sha256(PasswordRegBox.Text);
            CMD.Parameters.Add("@role", MySqlDbType.VarChar).Value = RoleComboBox.Text;
